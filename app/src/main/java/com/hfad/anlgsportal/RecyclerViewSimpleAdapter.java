...
public class RecyclerViewSimpleAdapter<T> extends androidx.recyclerview.widget.RecyclerView.Adapter<RecyclerViewSimpleAdapter<T>.MyViewHolder> {
    private static final String LOG_TAG = "recyclerviewsimpleadapt";
    ...
    public class MyViewHolder extends androidx.recyclerview.widget.RecyclerView.ViewHolder implements View.OnClickListener {
        final TextView view;
